export const products: (Omit<CartItem, "quantity"> & {
  ...
  // Group A Products
  {
    ...
    description: "Standard black dropper bottle with precise dispensing.",
    testGroup: "A",
  },
  {
    id: "2",
    name: "White Dropper - Standard",
    price: 270,
    ...
    description: "Standard white dropper bottle with smooth dispensing.",
    testGroup: "A",
  },
  // Group B Products
  {
    id: "3",
    name: "Black Dropper - Premium",
    price: 320,
    url: "https://images.unsplash.com/photo-1701056035604-6a7dd0efa0d7?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    relevantImage: [
      {
    ...
    description: "Premium black dropper bottle with enhanced features and luxury finish.",
    testGroup: "B",
  },
  {
    id: "4",
    name: "White Dropper - Premium",
    price: 300,
    url: "https://images.unsplash.com/photo-1695989599251-1c5433b4b47d?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    relevantImage: [
      {
    ...
    description: "Premium white dropper bottle with enhanced features and elegant finish.",
    testGroup: "B",
  },
  {
    id: "5",
